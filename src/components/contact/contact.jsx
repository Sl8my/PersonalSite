...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_GSIn7kpAuvrNXRMQs7PFE";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_k37ngyb";
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
            I am a native italian speaker but completely comfortable in English.
          </p>

          <Row className="padding40">
            <Col md={12} lg={6}>
            <h4 className="font30 weight800 padding30">Send Me a Message.</h4>
            <h4 className="font19 weight800 padding30"><a href="mailto:serravalledomenico@hotmail.com">serravalledomenico@hotmail.com</a></h4>
            <h4 className="font24 weight800 padding30"><a href="https://github.com/Sl8my" target="_blank" rel="noopener noreferrer">SEE GITHUB</a></h4>
