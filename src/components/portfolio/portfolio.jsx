...
import Preview2 from "../../assets/portfolio/project02/preview-01.png";
import Preview3 from "../../assets/portfolio/project03/preview-01.png";
import Preview4 from "../../assets/portfolio/project04/preview-01.png";
import Preview5 from "../../assets/portfolio/project05/preview-01.png";
import Preview6 from "../../assets/portfolio/project06/preview-01.png";
//Components
      ...
      projects: [
        {
          ...
          tag: "A Facebook clone made with React and Django REST Framework.",
        },
        {
          id: "2",
          preview: Preview2,
          title: "RevealApp",
          tag: "A service to retrieve and comment easily information regarding documents of interest.",
        },
        {
          id: "3",
          preview: Preview3,
          title: "TripAdvisor Clone",
          tag: "A TripAdvisor clore made with React and Django REST Framework, deployed with docker.",
        },
        {
          id: "4",
          preview: Preview4,
          title: "Black Moon",
          tag: "Designed a logo for a beauty saloon with Illustrator.",
        },
        {
          id: "5",
          preview: Preview5,
          title: "Dream Team Poker",
          tag: "Designed a logo for a poker room with Illustrator",
        },
        {
          id: "6",
          preview: Preview6,
          title: "ITM PARTY",
          tag: "Managed a party with over 500 tickets sold at Lugano's Beach.3",
        },
      ],
      ...
      <div id="portfolio">
        <div className="wrapper">
          ...
          <Row className="flex-center padding40">
            <Button label="DO YOU THINK I CAN FIT?" target={"contact"} />
          </Row>
        </div>
      </div>
    );
